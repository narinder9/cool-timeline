		 ...
		 public function add_meta_box_content( $post, $callback ) {
			 ...
			 if ( $has_nav ) {
				 ...
				 foreach ( $this->sections as $section ) {
					 ...
					 echo '<li><a href="#">' . esc_html( $tab_icon ) . esc_html( $section['title'] ) . esc_html( $tab_error ) . '</a></li>';
			 ...
			 foreach ( $this->sections as $section ) {
				 ...
				 echo ( $section_title || $section_icon ) ? '<div class="csf-section-title"><h3>' . esc_html( $section_icon ) . esc_html( $section_title ) . '</h3></div>' : '';
