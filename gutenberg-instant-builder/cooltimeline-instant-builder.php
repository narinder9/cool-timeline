...
class CoolTimelineInstantBuilder {
    ...
    private function __construct() {
		...
		add_filter( 'body_class', array($this,'gctl_timeline_body_class') );
		add_filter( 'admin_body_class', array($this,'gctl_timeline_body_class' ));
	...
	//Load body class
	function gctl_timeline_body_class( $classes ) {
